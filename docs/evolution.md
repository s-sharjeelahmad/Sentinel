...
**Interview Question:** *"Where should you put validation logic?"*
...
**Interview Question:** *"Why rate limit authenticated users?"*
...
**Interview Question:** *"What happens if server crashes while holding lock?"*
...
**Interview Question:** *"What metrics matter for an API?"*
...
**Interview Question:** *"What's the difference between timeout and circuit breaker?"*
